...
const glowUpPages: MagazinePage[] = [
  // Page 1: Cover
  {
    ...
    subtitle: 'Where Fashion Meets Sound Meets Art',
...
const summerSaucePages: MagazinePage[] = [
  // Page 1: Cover
  {
    ...
    pageNumber: 1,
    type: 'cover',
    title: 'The Sound Issue',
    subtitle: 'Music & Audio Culture',
    imageUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1200&h=1600&fit=crop',
    imageAlt: 'Music and culture editorial cover',
    category: 'Issue #2',
    backgroundColor: '#0A0A0A',
  },
  // Page 2: Table of Contents
...
export const mockIssues: MagazineIssue[] = [
  {
    id: 'issue-1',
    slug: 'the-culture-issue',
    title: 'The Culture Issue',
    issueNumber: 1,
    subtitle: 'Where Fashion Meets Sound Meets Art',
    description: 'Our inaugural issue explores the intersection of luxury, fashion, music, and art. Featuring the Street Luxe movement, artist spotlight Amara Osei, and a golden hour photo editorial that redefines editorial photography.',
  ...
  {
    id: 'issue-2',
    slug: 'the-sound-issue',
    title: 'The Sound Issue',
    issueNumber: 2,
    subtitle: 'Music & Audio Culture',
    description: 'A sonic journey across five cities — from the nightlife renaissance nobody predicted to rising artist Khalil Torres recording in his grandmother\'s Bronx apartment. Plus: The New Leisure — how Gen Z is reclaiming rest from the luxury-industrial complex.',
  ...
  },
  {
    ...
    description: 'Transformation across every dimension — from wardrobe evolutions and personal style reinventions to the artists who burned the old playbook and wrote something wilder, truer, and more alive.',
    coverImage: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=1200&h=1600&fit=crop',
