  ...
  return (
    <div
      ...
      className={`
        ...
        ${borderGlow ? 'border border-primary/[0.08]' : ''}
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(90deg, transparent 0%, rgba(57,255,20,${isHovering ? 0.2 : 0.08}) 50%, transparent 100%)`,
        }}
      />
      ...
      {borderGlow && isHovering && (
        <div
          ...
          style={{
            boxShadow: `inset 0 0 0 1px rgba(57,255,20,0.1), 0 0 30px ${glowColor}`,
            opacity: 0.5,
          }}
        />
      )}
