...
import type { MerchCategory, MerchStatus } from '@media-network/shared';
...
export default function NewProductPage() {
  ...
  function getBrandDisplayName(brand: string | null): string {
    if (!brand || brand === 'all') return 'Young Empire';
