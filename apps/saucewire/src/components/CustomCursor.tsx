...
export function CustomCursor() {
  ...
  // Detect touch device — don't show custom cursor on mobile
  ...
  // Smooth lerp animation for trail
  ...
  return (
    <>
      ...
      >
        <div
          className="relative -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/80 transition-all duration-300 ease-out flex items-center justify-center"
          style={{
        ...
        >
          ...
          {cursor.text && cursor.hovering && (
            <span
              className="text-[9px] font-mono text-white uppercase tracking-widest whitespace-nowrap opacity-80"
              style={{
