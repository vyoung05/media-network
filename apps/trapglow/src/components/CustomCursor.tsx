...
export function CustomCursor() {
  ...
  return (
    <>
      ...
      >
        <div
          className="relative -translate-x-1/2 -translate-y-1/2 rounded-full transition-all duration-200 ease-out"
          style={{
            width: cursor.clicking ? '6px' : '8px',
            height: cursor.clicking ? '6px' : '8px',
            background: 'linear-gradient(135deg, #8B5CF6, #06F5D6)',
          }}
        />
      </div>
      ...
      >
        <div
          ...
          style={{
            ...
            border: `1.5px solid rgba(139, 92, 246, ${cursor.hovering ? 0.6 : 0.3})`,
            boxShadow: cursor.hovering ? '0 0 20px rgba(139, 92, 246, 0.2)' : 'none',
          }}
        >
          {cursor.text && cursor.hovering && (
            <span
              className="text-[9px] font-body text-primary uppercase tracking-widest whitespace-nowrap opacity-80"
